...
{
    public class DailyFinishedOrderReportQueryValidations : AbstractValidator<DailyFinishedOrderReportQuery>
    {
        public DailyFinishedOrderReportQueryValidations()
        {
            ValidateDates();
            ValidateMinPrice();
        }
        ...
        {
            RuleFor(query => query.MinValue)
                .NotEmpty().NotNull()
                .WithMessage("O preço mínimo deve ser informado")
                .WithErrorCode("020");
        }
